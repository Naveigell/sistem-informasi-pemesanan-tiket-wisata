...
<div class="col-12 no-padding-margin my-5">
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group">
                @if($model->transaction_status->isPending())
                    <label><h2 class="text-weight-bold">Terima Transaksi dan Semua Tiket?</h2></label>
                    <div class="row ml-1">
            ...
            <div class="form-group">
                ...
                <input type="text" disabled value="{{ $model->customer_email }}" class="form-control">
            </div>
            <div class="form-group">
                <label>No Telp Customer</label>
                <input type="text" disabled value="{{ $model->customer_phone }}" class="form-control">
            </div>
            <div class="form-group">
                <label>Jumlah Tiket</label>
                <input type="text" disabled value="{{ $model->number_of_tickets }}" class="form-control">
            </div>
            <div class="form-group">
                <label>List Tiket</label>
                <input type="text" disabled value="{{ $model->transactionTickets->map(fn($ticket) => $ticket->name . ' (x' . $ticket->quantity . ')')->join(', ') }}" class="form-control">
            </div>
            <div class="form-group">
                <label>Qr Code</label>
                <div>
    ...
    <div class="row mt-2 pt-2">
        @foreach($model->transactionTickets as $ticket)
            <div class="col-4">
                <div class="card">
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Jumlah</label>
                            <input type="text" disabled class="form-control" value="{{ $ticket->quantity }}">
                        </div>
                    </div>
                </div>
            </div>
